...
namespace Bicubic
{
	class ResizeImage : IDisposable
	{
		...
		public static readonly string SupportExtensionFilter = "ビットマップファイル|*.bmp;*.dib;*.rle|Jpeg ファイル|*.jpg;*.jpeg;*.jpe;*.jfif|Gif ファイル|*.gif|Tiff ファイル|*.tif;*.tiff|サポートするすべての画像ファイル|*.bmp;*.dib;*.rle;*.jpg;*.jpeg;*.jpe;*.jfif;*.gif;*.tif;*.tiff";
